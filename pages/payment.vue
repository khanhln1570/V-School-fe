        ...
        <v-card
          ...
          <invoice-row
            ...
            <template #ammount="{ value, item }">
              <span class="txt-active--text ml-3">{{ numberToMoney(value) }}</span>
            </template>
    ...
    <main-modal
      ...
      <template #modalBody v-if="currentInvoice">
        <div class="d-flex justify-space-between mb-4">
          ...
          <p class="font-weight-bold text-right txt-success--text">{{numberToMoney(currentInvoice.ammount)}}</p>
        </div>
        <div class="d-flex justify-space-between">
            <p>Mã Phí thu: </p>
